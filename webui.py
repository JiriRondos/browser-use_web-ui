    ...
    with Translate(
        ...
        with gr.Blocks(
            ...
            def change_language(lang):
                ...
                return gr.update()
>>>>>>> c10902c3a2392763cff75468ca20b83331999751
            ...
            with gr.TabItem("🔧 Nastavení LLM", id=2):
                with gr.Group():
                    ...
                    llm_model_name = gr.Dropdown(
                        ...
                        interactive=True,
                        allow_custom_value=True,  # Allow users toVyberte model z rozbalovací nabídky nebo přímo zadejte vlastní název modelus
